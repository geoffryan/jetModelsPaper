...
The mapping between structured jet and refreshed shock (and hence energy injection) models is a two step process.  Firstly, a visual comparison between $\alpha_{\text{struct}}$ in Table \ref{tab:slopes} and $\alpha_{\text{refresh}}$ in Table \ref{tab:refreshSlopes} indicate the identical roles played by $g$ and $k$. Indeed, a stru
