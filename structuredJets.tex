...
\title{GRB Afterglows In The Multi-Messenger Era  \hspace{10in} OR\hspace{10in}   Electromagnetic Afterglows Of Structured Jets \hspace{10in}  OR\hspace{10in}  Structured Jets At All Angles\hspace{10in}  OR \hspace{10in}The Electromagnetic Afterglows of Structured Jets: Numerical Models and Closure Relations}
...
A solid theoretical understanding of structured jet afterglows, including viewing angle effects, will be required to make the most use of future GW-GRB observations, the \gwbns{} dataset, and re-analysis of archival short GRBs.  % Mention standard tools, explain closure relations
...
\end{align}
% TODO: Update spreading description
...
We can write the received flux as:
\begin{equation}
	F_\nu = I_\nu^*\ \Delta \Omega\ , 
\end{equation}
where $I_\nu^* = I_\nu(\theta^*)$ is the peak specific intensity, located at $\theta=\theta^*$ and $\phi=0$, and $\Delta \Omega$ is the effective solid angle of the blast wave contributing to the emission. 

From the definition of $\thC$ in Equation \eqref{eq:thCdef} we can see $E(\theta) = E_0(1 - \theta^2/(2\thC^2) + \OO(\theta^3))$. 
...
\begin{deluxetable*}{CCCCCCCC}
	...
	\nu_m, \nu_c < \nu & H 	& 8 - 3p/2 	& \dfrac{-6p - 2 + 3\som + 2g}{8+g} 	& \dfrac{1-6p  +2g}{8+g} 	& -3p/4	& -(3p+1)/4 & -p/2 \\[0.3cm]
	\enddata
\end{deluxetable*}
